...
All internal models live in `com.kubeflow.model`. The four core models are
...
Thresholds are configured via `kubeflow.cpu-*-threshold` and
`kubeflow.mem-*-threshold` (see [configuration.md](configuration.md)).
